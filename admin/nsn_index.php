...
<div class="wrap">
	...
	<img style="float:right;display:inline-block;opacity: 0.8;" alt="NORD" src="<?php echo plugin_dir_url( __FILE__ ).'Nord2-01.png' ?>"  />
	</div>
	...
	<div id="poststuff">
		...
		<div id="post-body" class="metabox-holder columns-1">
			...
			if($totalPage > 1){
				$customPagHTML =  '<div class="nsn-sort"><span>Page '.$page.' of '.$totalPage.'</span>'.paginate_links( array(
            ...
            <?php
				...
				if (current_user_can('manage_options')) {
					...
					<input class="button" name="nsn_reload" type="submit" value="Load / Reload List" style="background-color:#46B450;color:#ffffff; margin-left:16px" />
						<br class="clear">
				</form>
				<br class="clear">
